...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-xl font-bold text-gray-800">Edit User</span>
                </div>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-500">Edit User</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Edit User: {{ $user->nama }}</h1>
                <p class="text-gray-600 mt-2">Update informasi user (kosongkan password jika tidak ingin mengubah)</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select 
                        ...
                        required
                    >
                        <option value="admin_rumah_sakit" {{ old('role', $user->role) === 'admin_rumah_sakit' ? 'selected' : '' }}>Admin Rumah Sakit</option>
