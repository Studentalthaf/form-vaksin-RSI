                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-10 h-10 rounded-full {{ $user->role === 'admin_rumah_sakit' ? 'bg-red-100' : 'bg-green-100' }} flex items-center justify-center">
                                    <span class="text-sm font-medium {{ $user->role === 'admin_rumah_sakit' ? 'text-red-600' : 'text-green-600' }}">
