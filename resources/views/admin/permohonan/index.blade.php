        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-t-4 border-red-500">
            ...
            <form method="GET" action="{{ route('admin.permohonan.index') }}" id="filterForm" class="space-y-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-2">
                    ...
                    <a href="{{ route('admin.permohonan.index') }}?tab={{ $activeTab }}" class="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-bold shadow-md hover:shadow-lg transition-all flex items-center justify-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
