<!-- Tabel Permohonan PENDING -->
<table class="w-full">
    <thead class="bg-yellow-600 text-white">
        <tr>
            <th class="px-4 py-4 text-left text-sm font-semibold">No</th>
            <th class="px-4 py-4 text-left text-sm font-semibold">Tanggal</th>
    ...
    <tbody class="divide-y divide-gray-200">
        ...
        <tr>
            <td colspan="7" class="px-6 py-12 text-center">
                ...
                <p class="text-gray-500 font-semibold">Tidak ada permohonan pending</p>
                <p class="text-gray-400 text-sm mt-1">Semua permohonan sudah disetujui</p>
            </td>
        </tr>
        @endforelse
    </tbody>
