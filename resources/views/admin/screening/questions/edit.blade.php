...
@section('page-title', 'Edit Pertanyaan Screening')
@section('page-subtitle', 'Ubah informasi pertanyaan screening')
...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-red-100 text-sm mt-1">Ubah informasi pertanyaan screening</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Form Content -->
        <form method="POST" action="{{ route('admin.screening.questions.update', $question) }}" class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <input type="checkbox" 
                               ...
                               id="aktif" 
                               value="1" 
                               {{ old('aktif', $question->aktif) ? 'checked' : '' }} 
                               class="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500">
