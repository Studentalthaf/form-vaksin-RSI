...
@section('page-title', 'Tambah Kategori Pertanyaan')
@section('page-subtitle', 'Tambah kategori baru untuk pertanyaan screening')
...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-indigo-100 text-sm mt-1">Isi formulir di bawah untuk menambahkan kategori pertanyaan screening</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Form Content -->
        <form method="POST" action="{{ route('admin.screening.categories.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="deskripsi" 
                          ...
                          placeholder="Jelaskan lebih detail tentang kategori ini (opsional)">{{ old('deskripsi') }}</textarea>
