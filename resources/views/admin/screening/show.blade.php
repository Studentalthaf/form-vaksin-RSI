                ...
                <div class="p-6">
                    <form method="POST" action="{{ $screening->nilaiScreening 
                        ...
                        <div class="mb-6 bg-blue-50 p-4 rounded-lg">
                            <h3 class="font-semibold text-blue-900 mb-2">Informasi Permohonan</h3>
                            <div class="grid grid-cols-2 gap-3 text-sm">
                                <div>
                                    <span class="text-gray-600">Jenis Vaksin:</span>
                                    <p class="font-semibold">{{ is_array($permohonan->jenis_vaksin) ? implode(', ', $permohonan->jenis_vaksin) : $permohonan->jenis_vaksin }}</p>
                                </div>
                                <div>
                                    <span class="text-gray-600">Negara Tujuan:</span>
                                    <p class="font-semibold">{{ $permohonan->negara_tujuan ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
