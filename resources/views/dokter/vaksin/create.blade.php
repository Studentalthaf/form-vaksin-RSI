...
@section('page-title', 'Tambah Vaksin')
@section('page-subtitle', 'Tambah vaksin baru ke daftar')

@section('content')
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="mb-6">
            <a href="{{ route('dokter.vaksin.index') }}" class="inline-flex items-center text-green-600 hover:text-green-700 font-semibold">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Vaksin Baru</h1>

        <form action="{{ route('dokter.vaksin.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('nama_vaksin') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" 
                              ...
                              placeholder="Deskripsi singkat tentang vaksin (opsional)">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t">
                    <a href="{{ route('dokter.vaksin.index') }}" 
                       class="px-6 py-2.5 border border-gray-300 rounded-lg text-gray-700 font-semibold hover:bg-gray-50 transition">
                        Batal
                    </a>
                    <button type="submit" 
                            class="px-6 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-200">
                        Simpan Vaksin
                    </button>
                </div>
            </div>
